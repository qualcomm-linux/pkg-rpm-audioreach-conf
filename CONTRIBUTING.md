# Contributing to pkg-rpm-audioreach-conf
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-rpm-audioreach-conf.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-rpm-audioreach-conf/pulls) from your branch to `main`.
